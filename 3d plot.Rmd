...
```{r, include = F}
setwd("~/Desktop/MArch-Columbia/4 - ADR 2/Assignment 1C")
dat <- openxlsx::read.xlsx("/Users/Young/Desktop/MArch-Columbia/4 - ADR 2/Assignment 1C/ADR2 - 2A - DEAR SYSTEMS .xlsx", sheet = 2)
